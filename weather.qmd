...
It is important to emphasize how the user interface separates the untrusted AI model conversation on the left from the trusted weather data on the right.
The AI-reported weather in the chat may be a hallucination, and the user should not rely on it.
...
The leaflet map renders the coordinates the AI model picked, so the user can check whether the AI model's resolution of their query looks correct.
